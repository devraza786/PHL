        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl">
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              ...
              <span className="text-white font-extrabold">Pristine Hardscape</span>
            </h1>
            <p className="text-xl md:text-2xl text-gray-200 mb-8 leading-relaxed">
              Custom patios, driveways, walkways & expert landscape design serving The Villages
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button
                ...
                size="lg"
                className="bg-white hover:bg-gray-100 text-black font-bold text-lg px-8 py-6 h-auto"
              >
                Request a Quote
              </Button>
              <Button
                ...
                size="lg"
                className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-black font-semibold text-lg px-8 py-6 h-auto"
              >
                View Our Work
              </Button>
            </div>
